...
\subsection{Simulating Human Characters}
\subsection{Simulating Environments} %optional
\subsubsection{Rigid Body}%optional
\subsubsection{Soft Body}%optional
\subsubsection{Fluid}%optional
\subsection{Simulating Two-way Interactions}
\subsubsection{Contact}
\subsubsection{Hydrodynamic Coupling} %optional
